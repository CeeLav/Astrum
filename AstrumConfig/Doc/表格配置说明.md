...
**作用**: 定义玩家角色的游戏属性，包括基础属性、成长系数、技能配置等。
...
**作用**: 定义角色在不同等级下的成长配置，包括属性加成、技能点等。
