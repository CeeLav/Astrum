...
战斗系统是Astrum项目中负责攻击判定、受击判定和打击感效果的核心系统。该系统专注于基础的战斗逻辑，与动作系统和技能系统紧密配合。
...
**系统边界**：
- ✅ 负责：基础攻击判定、受击判定、打击感效果
- ❌ 不负责：技能逻辑、技能效果、技能表现（详见[技能系统策划案](./技能系统策划案.md)）
...
### 3.1 系统分工
- **战斗系统**：提供基础的攻击判定、受击判定、打击感效果
- **技能系统**：基于战斗系统实现复杂的技能逻辑和效果
- **集成方式**：技能系统通过AttackInfo、AttackBoxTurnOnInfo等战斗数据结构实现技能效果

### 3.2 数据流转
```
技能释放 → 技能系统 → 战斗系统
技能效果 → AttackInfo/BeHitInfo → 战斗判定 → 打击感效果
```

详细的技能系统设计请参考：[技能系统策划案](./技能系统策划案.md)
...
### 4.2 攻击盒激活信息 (AttackBoxTurnOnInfo)
...
### 4.3 受击盒激活信息 (BeHitBoxTurnOnInfo)
...
本战斗系统策划案专注于攻击判定、受击判定和打击感效果，与动作系统和技能系统紧密配合，为Astrum项目提供完整的战斗体验。

**系统职责总结**：
- ✅ **核心职责**：攻击判定、受击判定、打击感效果
- ✅ **基础支持**：为技能系统提供战斗数据结构和判定逻辑
- ❌ **非职责范围**：技能逻辑、技能效果、技能表现（详见[技能系统策划案](./技能系统策划案.md)）

**相关文档**：
- [动作系统策划案](./ActionSystem/动作系统策划案.md) - 动作管理和执行
- [技能系统策划案](./技能系统策划案.md) - 技能逻辑和效果
