...
{
    /// <summary>
    /// Idle 状态能力（旧架构，已废弃，保留用于兼容）
    /// </summary>
    using System;
    using Astrum.LogicCore.Components;
    using MemoryPack;
    [MemoryPackable]
    public partial class IdleStateCapabilityOld : Capability
    {
        ...
        public override bool CanExecute()
        {
            ...
            return OwnerHasComponent<AIStateMachineComponent>() && OwnerHasComponent<TransComponent>();
        }
    }
}
