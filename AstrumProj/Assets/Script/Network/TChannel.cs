...
namespace Astrum.Network
{
	...
	public sealed class TChannel: AChannel
	{
		...
		public override void Dispose()
		{
			...
			ASLogger.Instance.Info($"channel dispose: {this.Id} {this.RemoteAddress} {this.Error}");
		...
		public void StartRecv()
		{
			while (true)
			{
				...
				{
					ASLogger.Instance.Error($"tchannel error: {this.Id}\n{e}");
		...
		private void HandleRecv(SocketAsyncEventArgs e)
		{
			...
			while (true)
			{
				...
				{
					ASLogger.Instance.Error($"ip: {this.RemoteAddress} {ee}");
		...
		private void OnRead(MemoryBuffer memoryStream)
		{
			...
			{
				ASLogger.Instance.Error($"OnRead error: {e.Message}");
		...
		{
			ASLogger.Instance.Info($"TChannel OnError: {error} {this.RemoteAddress}");
