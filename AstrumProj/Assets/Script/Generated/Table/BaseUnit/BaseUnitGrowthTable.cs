...
{
public sealed partial class BaseUnitGrowthTable : Luban.BeanBase
{
    public BaseUnitGrowthTable(ByteBuf _buf) 
    {
        Id = _buf.ReadInt();
    ...
    public static BaseUnitGrowthTable DeserializeBaseUnitGrowthTable(ByteBuf _buf)
    {
        return new BaseUnit.BaseUnitGrowthTable(_buf);
    }
    ...
    public const int __ID__ = 501239705;
