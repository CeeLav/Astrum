...
{
public sealed partial class BaseUnitStatsTable : Luban.BeanBase
{
    public BaseUnitStatsTable(ByteBuf _buf) 
    {
    ...
    public static BaseUnitStatsTable DeserializeBaseUnitStatsTable(ByteBuf _buf)
    {
        return new BaseUnit.BaseUnitStatsTable(_buf);
    }
    ...
    public const int __ID__ = 1848458973;
