...
{
    /// <summary>
    /// BaseUnitStatsTable 映射类
    /// 对应 AstrumConfig/Tables/Datas/BaseUnit/#BaseUnitStatsTable.csv
    /// </summary>
    [System.Serializable]
    public class BaseUnitStatsTableData
    {
        ...
        public static LubanTableConfig GetTableConfig()
        {
            ...
            {
                FilePath = "AstrumConfig/Tables/Datas/BaseUnit/#BaseUnitStatsTable.csv",
                HeaderLines = 4,
