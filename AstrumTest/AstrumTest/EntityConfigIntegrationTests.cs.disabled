...
namespace AstrumTest.PhysicsTests
{
    ...
    public class EntityConfigIntegrationTests : IDisposable
    {
        ...
        public void Test_CompleteCollisionDetectionWithConfig()
        {
            ...
            _output.WriteLine($"Target entity created at {target.GetComponent<PositionComponent>().Position}");
            
            // 创建施法者实体
            var caster = new Entity();
            var casterPos = new PositionComponent { Position = TSVector.zero };
        ...
        public void Test_MultipleEntitiesCollisionDetection()
        {
            ...
            // 创建施法者
            var caster = new Entity();
            caster.AddComponent(new PositionComponent { Position = TSVector.zero });
