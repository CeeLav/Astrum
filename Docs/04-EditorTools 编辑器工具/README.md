...
#### [场景编辑器设计](场景编辑器/Scene-Editor-Design%20场景编辑器设计.md)
场景触发器编辑器的技术设计文档
...
#### [参数转换器设计](场景编辑器/Scene-Trigger-Parameter-Converter-Design%20参数转换器设计.md)
参数转换器系统的技术设计文档
...
- [特效轨道开发进展](开发进展/VFX-Track-Progress%20特效轨道开发进展.md) - 📝 **v0.0.0** (设计完成，待开发)
